  ...
  return (
    <>
      {Array.from({ length: count }).map((_, i) => (
        <div 
          key={i} 
          className="animate-pulse space-y-4 p-6 bg-zinc-800/30 rounded-xl border border-zinc-700/50 mb-4"
        >
          ...
          <div className="space-y-2">
            ...
            <div className="h-4 bg-zinc-700 rounded w-3/6" />
          </div>
...
export const CommentSkeletonSingle = () => (
  <div className="animate-pulse space-y-4 p-6 bg-zinc-800/30 rounded-xl border border-zinc-700/50">
    <div className="flex items-center space-x-3">
      <div className="h-10 w-10 rounded-full bg-zinc-700" />
      <div className="space-y-2">
        <div className="h-4 w-32 bg-zinc-700 rounded" />
